...
import { StaffPromotionView } from "./StaffPromotionView";

export const StaffPromotionPage: React.FC = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 min-h-[85vh]">
      ...
      {/* Main Staff Promotion Content */}
      <div className="bg-white border border-[#0B1B3D] rounded-2xl p-4 sm:p-6 shadow-none">
        <StaffPromotionView hideTopTitle />
      </div>
    </div>
  );
};
